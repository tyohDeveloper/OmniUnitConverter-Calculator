...
- [Build size ceiling](build-size-ceiling.md) — verify-build enforces a gzip ceiling on the single-file build; ~26 kB headroom after July 2026 re-baseline; audit growth is legitimate data before re-baselining.
