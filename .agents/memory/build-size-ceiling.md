...
---
The rule: `scripts/verify-build.mjs` enforces gzip size ≤ baseline × 1.05 (baseline re-recorded 2026-07-19 at 434.3 kB gzip, ceiling ~456 kB — about 21 kB headroom).
