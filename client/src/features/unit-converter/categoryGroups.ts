...
export const CATEGORY_GROUPS: ReadonlyArray<CategoryGroup> = [
  ...
  { name: 'Other', categories: ['data', 'fuel', 'fuel_economy', 'rack_geometry', 'shipping', 'beer_wine_volume', 'lightbulb', 'paper_sizes', 'typography', 'cooking', 'logarithmic', 'timezone', 'date_calendar', 'unitless'] },
