...
export const CATEGORY_DIMENSIONS: Record<string, CategoryDimensionInfo> = {
  ...
  archaic_length: { name: 'Archaic & Regional Length', dimensions: { length: 1 }, isBase: false },
  archaic_mass: { name: 'Archaic & Regional Mass', dimensions: { mass: 1 }, isBase: false },
  archaic_volume: { name: 'Archaic & Regional Volume', dimensions: { length: 3 }, isBase: false },
  archaic_area: { name: 'Archaic & Regional Area', dimensions: { length: 2 }, isBase: false },
  archaic_energy: { name: 'Archaic & Regional Energy', dimensions: { mass: 1, length: 2, time: -2 }, isBase: false },
  archaic_power: { name: 'Archaic & Regional Power', dimensions: { mass: 1, length: 2, time: -3 }, isBase: false },
